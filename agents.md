...
- **Segmented controls** (`Picker` + `.pickerStyle(.segmented)`): Use for **2–5 mutually exclusive panes** in a single settings surface (e.g. Image / PDF / Video under Presets). This matches System Settings patterns and avoids long vertical scrolling for parallel option groups.
