...
- **Download:** [Dinky for macOS (DMG)](https://github.com/heyderekj/dinky/releases/download/v2.9.0/Dinky-2.9.0.dmg) — or install with [Homebrew](https://brew.sh): `brew tap heyderekj/dinky https://github.com/heyderekj/dinky` then `brew install --cask dinky`
- **Source:** [GitHub — heyderekj/dinky](https://github.com/heyderekj/dinky)
- **Support:** [help@dinkyfiles.com](mailto:help@dinkyfiles.com)
- **Version:** 33 MB · v2.9.0 · Requires macOS 15 Sequoia or later
