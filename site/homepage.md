...
A tiny macOS app for **images**, **videos**, and **PDFs**. Convert stills to WebP, AVIF, or lossless PNG; export video to smaller MP4 with **H.264** or **HEVC**; shrink PDFs while keeping text and links or flatten pages for maximum savings. Drag and drop, get smaller files back. Free and open source.

- **Download:** [Dinky for macOS (DMG)](https://github.com/heyderekj/dinky/releases/download/v2.1.1/Dinky-2.1.1.dmg)
- **Source:** [GitHub — heyderekj/dinky](https://github.com/heyderekj/dinky)
- **Support:** [help@dinkyfiles.com](mailto:help@dinkyfiles.com)
- **Version:** ~16 MB · v2.1.1 · Requires macOS 15 Sequoia or later
