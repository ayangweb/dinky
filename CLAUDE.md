...
Dinky is ~4 MB. That's the whole point. Before adding **anything** — a framework, dependency, asset, font, or feature — mentally check its bundle size impact first.
...
**Current footprint reference:** Dinky 4.1 MB vs Optimage 62 MB vs ImageOptim 17.6 MB. Keep it dinky.
