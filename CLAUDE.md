...
Dinky is 33 MB installed (image/video encoders plus bundled **qpdf** and its dylibs, e.g. OpenSSL). That's still the whole point: before adding **anything** — a framework, dependency, asset, font, or feature — mentally check its bundle size impact first.
...
**Current footprint reference:** Dinky 33 MB vs Optimage 62 MB vs ImageOptim 17.6 MB. Keep it dinky.
